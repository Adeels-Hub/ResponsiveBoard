...
Applied **React Router** for client-side routing
Incorporated **Formik** and **Yup** for efficient form handling and validation.
Utilized **Axios** for efficient API communication
